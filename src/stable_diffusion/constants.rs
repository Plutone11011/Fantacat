...
pub const REPO_TOKENIZER_XLTURBO: &str = "openai/clip-vit-large-patch14";
...
pub const REPO_XL: &str = "stabilityai/stable-diffusion-xl-base-1.0";
pub const REPO_TURBO: &str = "stabilityai/sdxl-turbo";
pub const REPO_VAE_XLTURBO_FP16: &str = "madebyollin/sdxl-vae-fp16-fix";
...
pub const MODELFILE_CLIP2: &str = "text_encoder_2/model.safetensors";
pub const MODELFILE_CLIP2_FP16: &str = "text_encoder_2/model.fp16.safetensors";
